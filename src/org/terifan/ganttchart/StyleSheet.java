...
//	static Color ROW_LIGHT = new Color(255, 255, 255);
//	static Color ROW_DARK = new Color(242, 242, 242);
//	static Color SELECTION_COLOR = new Color(0.0f, 0.3f, 0.6f);
//	static Color FLOWLINE = new Color(220, 220, 220);
//	static Color LINE_COLOR_SELECTED = Color.WHITE;
//	static Color LINE_COLOR_UNSELECTED = Color.BLACK;
//	static Color TEXT_COLOR_SELECTED = Color.WHITE;
